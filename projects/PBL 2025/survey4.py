...
def survey4(app, main_content_rect, step_value_survey):
    ...
    options = ["Improve grades: Score better grades during exams",
               "Reduce anxiety: Manage exam-related stress",
               "Understand material: Gain a deeper understanding of subjects",
               "Time management: Learn to balance study and leisure"
               ]
    ...
    studying_level_label = ctk.CTkLabel(main_content_rect, text="What is your main objective?", font=ctk.CTkFont(size=30, family="Arial"), bg_color="#ffffff")
    studying_level_label.place(relx=0.27, rely=0.45)

    rb1 = ctk.CTkRadioButton(app, text="Improve grades: Score better grades during exams", bg_color="#FFFFFF", variable=selected_option, value="1", font=ctk.CTkFont(size=15, family="Arial"), hover_color="#0059ff", width=500, height=40, corner_radius=10)
    rb1.place(x=850, y=600)
    rb2 = ctk.CTkRadioButton(app, text="Reduce anxiety: Manage exam-related stress", bg_color="#FFFFFF", variable=selected_option, value="2", font=ctk.CTkFont(size=15, family="Arial"), hover_color="#0059ff", width=500, height=40, corner_radius=10)
    rb2.place(x=850, y=650)
    rb3 = ctk.CTkRadioButton(app, text="Understand material: Gain a deeper understanding of subjects", bg_color="#FFFFFF", variable=selected_option, value="3", font=ctk.CTkFont(size=15, family="Arial"), hover_color="#0059ff", width=500, height=40, corner_radius=10)
    rb3.place(x=850, y=700)
    rb4 = ctk.CTkRadioButton(app, text="Time management: Learn to balance study and leisure", bg_color="#FFFFFF", variable=selected_option, value="4", font=ctk.CTkFont(size=15, family="Arial"), hover_color="#0059ff", width=500, height=40, corner_radius=10)
    ...
    def next_step5():
        ...
        import survey5
        survey5.survey5(app, main_content_rect, step_value_survey)

    survey_submit = ctk.CTkButton(app, text="Next", font=ctk.CTkFont(size=20, family="Arial"), fg_color="#0059ff", hover_color="#0041c4", width=200, height=50, corner_radius=10, command=next_step5)

...
def survey7(app, main_content_rect, step_value_survey):
    ...
    studying_level_label = ctk.CTkLabel(main_content_rect, text="What stress relief techniques appeal to you?", font=ctk.CTkFont(size=30, family="Arial"), bg_color="#ffffff")
    studying_level_label.place(relx=0.237, rely=0.45)

    rb1 = ctk.CTkRadioButton(app, text="Breathing Exercises: Deep breathing, mindfulness", bg_color="#FFFFFF", variable=selected_option, value="1", font=ctk.CTkFont(size=15, family="Arial"), hover_color="#0059ff", width=500, height=40, corner_radius=10)
    rb1.place(x=850, y=600)
    rb2 = ctk.CTkRadioButton(app, text="Meditation: zen practices", bg_color="#FFFFFF", variable=selected_option, value="2", font=ctk.CTkFont(size=15, family="Arial"), hover_color="#0059ff", width=500, height=40, corner_radius=10)
    rb2.place(x=850, y=650)
    rb3 = ctk.CTkRadioButton(app, text="Music and Movement: calming sounds, yoga", bg_color="#FFFFFF", variable=selected_option, value="3", font=ctk.CTkFont(size=15, family="Arial"), hover_color="#0059ff", width=500, height=40, corner_radius=10)
    rb3.place(x=850, y=700)
    rb4 = ctk.CTkRadioButton(app, text="Nature: Outdoor scenes, soft breeze", bg_color="#FFFFFF", variable=selected_option, value="4", font=ctk.CTkFont(size=15, family="Arial"), hover_color="#0059ff", width=500, height=40, corner_radius=10)
    ...
    survey_submit = ctk.CTkButton(app, text="Start Learning", font=ctk.CTkFont(size=20, family="Arial"), fg_color="#0059ff", hover_color="#0041c4", width=200, height=50, corner_radius=10, command=next_step7)

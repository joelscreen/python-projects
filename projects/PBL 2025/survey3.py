...
def survey3(app, main_content_rect, step_value_survey):
    ...
    options = ["Very low: Feeling very relaxed",
               "Low: Generally calm, but slightly anxious",
               "Moderate: Often feeling stressed",
               "High: Constantly overwhelmed"
               ]
    ...
    studying_level_label = ctk.CTkLabel(main_content_rect, text="How do you feel during tests?", font=ctk.CTkFont(size=30, family="Arial"), bg_color="#ffffff")
    studying_level_label.place(relx=0.27, rely=0.45)

    rb1 = ctk.CTkRadioButton(app, text="Calm: Feeling very relaxed", bg_color="#FFFFFF", variable=selected_option, value="1", font=ctk.CTkFont(size=15, family="Arial"), hover_color="#0059ff", width=500, height=40, corner_radius=10)
    rb1.place(x=850, y=600)
    rb2 = ctk.CTkRadioButton(app, text="Little anxiety: Generally calm, but slightly anxious", bg_color="#FFFFFF", variable=selected_option, value="2", font=ctk.CTkFont(size=15, family="Arial"), hover_color="#0059ff", width=500, height=40, corner_radius=10)
    rb2.place(x=850, y=650)
    rb3 = ctk.CTkRadioButton(app, text="Stressed: Often feeling stressed", bg_color="#FFFFFF", variable=selected_option, value="3", font=ctk.CTkFont(size=15, family="Arial"), hover_color="#0059ff", width=500, height=40, corner_radius=10)
    rb3.place(x=850, y=700)
    rb4 = ctk.CTkRadioButton(app, text="Very anxious: Constantly overwhelmed", bg_color="#FFFFFF", variable=selected_option, value="4", font=ctk.CTkFont(size=15, family="Arial"), hover_color="#0059ff", width=500, height=40, corner_radius=10)
    ...
    def next_step4():
        ...
        import survey4
        survey4.survey4(app, main_content_rect, step_value_survey)
    
    survey_submit = ctk.CTkButton(app, text="Next", font=ctk.CTkFont(size=20, family="Arial"), fg_color="#0059ff", hover_color="#0041c4", width=200, height=50, corner_radius=10, command=next_step4)
